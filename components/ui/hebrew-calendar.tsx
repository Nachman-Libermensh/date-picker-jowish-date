  ...
  >(
    () => ({
      formatCaption: (monthDate) => {
        ...
        return formatJewishDateInHebrew(jewishDate, "MMMM YYYY")
      },
      formatDay: (dayDate) => {
        return formatJewishDateInHebrew(toJewishDate(dayDate), "D")
      },
      formatWeekdayName: (weekdayDate) => weekdayLabels[weekdayDate.getDay()],
      formatYearDropdown: (yearDate) => {
        return formatJewishDateInHebrew(toJewishDate(yearDate), "YYYY")
      },
      formatMonthDropdown: (monthDate) => {
        return formatJewishDateInHebrew(toJewishDate(monthDate), "MMMM")
      },
    }),
    []
  )
